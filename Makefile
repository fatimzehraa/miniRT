...
FILES = main.o render.o camera.o vec.o vec_adding.o vec_multipliying.o shapes/sphere.o shapes/plane.o shapes/cylinder.o shapes/lists.o utils.o light.o\
		parse/parse.o parse/parse_shape.o parse/str.o parse/utils.o parse/gnl/get_next_line.o parse/gnl/get_next_line_utils.o debug.o
